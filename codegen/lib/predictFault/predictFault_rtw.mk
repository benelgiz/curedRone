###########################################################################
## Makefile generated for MATLAB file/project 'predictFault'. 
## 
## Makefile     : predictFault_rtw.mk
## Generated on : Mon Aug 28 11:28:01 2017
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/predictFault.a
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/dronel/Desktop/curedRone
ARCH                      = maci64
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/predictFault.a
...
INCLUDES_BUILDINFO = -I$(START_DIR)/codegen/lib/predictFault -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=predictFault -DHAVESTDIO -DUSE_RTMODEL -DUNIX
...
SRCS = $(START_DIR)/codegen/lib/predictFault/predictFault.c
...
%.o : $(START_DIR)/codegen/lib/predictFault/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/predictFault/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
