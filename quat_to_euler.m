...
euler_ang_radian = [atan2(2 * (quater(1,:) .* quater(2,:) + quater(3,:) .* quater(4,:)), ...
    1 - 2 * ((quater(2,:)).^2 + (quater(3,:)).^2));...
    asin(2 * (quater(1,:) .* quater(3,:) - quater(4,:) .* quater(2,:))); ...
    atan2(2 * (quater(1,:) .* quater(4,:) + quater(2,:) .* quater(3,:)), ...
    1 - 2 * ((quater(3,:)).^2 + (quater(4,:)).^2))];
euler_ang = rad2deg(euler_ang_radian);